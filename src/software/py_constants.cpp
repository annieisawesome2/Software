...
PYBIND11_MODULE(py_constants, m)
{
    ...
    m.attr("ROBOT_CURRENT_DRAW_CONFIG_KEY")      = ROBOT_CURRENT_DRAW_CONFIG_KEY;
    m.attr("ROBOT_BATTERY_VOLTAGE_CONFIG_KEY")   = ROBOT_BATTERY_VOLTAGE_CONFIG_KEY;
    m.attr("ROBOT_CAPACITOR_VOLTAGE_CONFIG_KEY") = ROBOT_CAPACITOR_VOLTAGE_CONFIG_KEY;
